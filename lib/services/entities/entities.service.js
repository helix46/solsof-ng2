...
var EntitiesService = (function () {
    function EntitiesService(http, router) {
        this.http = http;
        this.router = router;
        helper_service_1.HelperService.logError('constructor EntitiesService');
    }
    EntitiesService.prototype.parseResponse = function (res) {
        return res.json();
    };
    EntitiesService.prototype.getEntities = function (excludeInactive) {
        var parameters = [];
        parameters[0] = {
        ...
        return httpHandlerService.getObject(parameters, 'api/entities');
    };
