...
var LoginService = (function () {
    function LoginService(http, router, callback) {
        ...
        helper_service_1.HelperService.logError('constructor LoginService');
    }
    ...
    LoginService.prototype.authenticate = function (username, password) {
        ...
        this.http
            ...
            .subscribe(function (response) { return _this.storeToken(response, username); }, this.logError, function () { return helper_service_1.HelperService.logError('Authentication Complete'); });
    };
