...
var InvoicesService = (function () {
    function InvoicesService(http, router) {
        this.http = http;
        this.router = router;
        helper_service_1.HelperService.logError('constructor InvoicesService');
    }
    InvoicesService.prototype.parseResponse = function (res) {
        return res.json();
    };
    InvoicesService.prototype.getInvoices = function (EntityId) {
        var parameters = [];
        parameters[0] = {
            name: 'entityID',
        ...
        return httpHandlerService.getObject(parameters, 'api/invoices');
    };
