...
var LedgerAccountsComponent = (function () {
    function LedgerAccountsComponent(ledgerAccountsService, router) {
        ...
        this.loadLedgerAccounts = function () {
            ...
            function complete() {
                helper_service_1.HelperService.logError('getLedgerAccounts complete');
            }
        ...
        this.onRowClicked = function (params) {
            ...
            helper_service_1.HelperService.logError('LedgerAccount onRowClicked');
        };
        ...
        helper_service_1.HelperService.logError('constructor LedgerAccountsComponent');
        this.getLedgerAccountsSuccess = true;
