...
var LedgerAccount_component_1 = require('../LedgerAccount/LedgerAccount.component');
var main_1 = require('ag-grid-ng2/main');
require('ag-grid-enterprise/main');
var LedgerAccountsComponent = (function () {
    //editledgerAccount: boolean;
    function LedgerAccountsComponent(ledgerAccountComponent, ledgerAccountsService, router) {
        var _this = this;
        this.ledgerAccountComponent = ledgerAccountComponent;
    ...
    LedgerAccountsComponent = __decorate([
        core_1.Component({
            ...
            pipes: [],
            providers: [LedgerAccounts_service_1.LedgerAccountsService, ledgerAccount_service_1.LedgerAccountService, LedgerAccount_component_1.LedgerAccountComponent],
            directives: [LedgerAccount_component_1.LedgerAccountComponent, main_1.AgGridNg2]
        }), 
        __metadata('design:paramtypes', [LedgerAccount_component_1.LedgerAccountComponent, LedgerAccounts_service_1.LedgerAccountsService, router_deprecated_1.Router])
