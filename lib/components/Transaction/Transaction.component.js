    ...
    function TransactionComponent(transactionService, router) {
        ...
        this.getTransaction = function (transactionID, ledgerAccounts, bankAccounts, copyTransaction) {
            ...
            function logTransactionError() {
                helper_service_1.HelperService.log('getTransaction Error');
        ...
        this.okClicked = function () {
            ...
            function logError(obj) {
                helper_service_1.HelperService.log(obj);
                helper_service_1.HelperService.log(JSON.stringify(obj));
            }
            function complete() {
                helper_service_1.HelperService.log('transaction complete');
            }
            function updateTransactionSuccess(response) {
                helper_service_1.HelperService.log('updateTransactionSuccess');
        ...
        helper_service_1.HelperService.log('constructor transactionComponent');
    }
