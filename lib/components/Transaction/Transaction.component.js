    ...
    function TransactionComponent(transactionService, router) {
        ...
        this.getTransaction = function (transactionID, ledgerAccounts, bankAccounts, copyTransaction) {
            ...
            function logTransactionError() {
                helper_service_1.HelperService.logError('getTransaction Error');
        ...
        this.okClicked = function () {
            ...
            function logError(obj) {
                helper_service_1.HelperService.logError(obj);
                helper_service_1.HelperService.logError(JSON.stringify(obj));
            }
            function complete() {
                helper_service_1.HelperService.logError('transaction complete');
            }
            function updateTransactionSuccess(response) {
                helper_service_1.HelperService.logError('updateTransactionSuccess');
        ...
        helper_service_1.HelperService.logError('constructor transactionComponent');
    }
