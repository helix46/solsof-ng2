...
var EntitiesComponent = (function () {
    function EntitiesComponent(router, entitiesService) {
        ...
        this.loadEntities = function () {
            ...
            function logError(e) {
                helper_service_1.HelperService.log('getEntities Error');
                loadEntitiesThis.getEntitiesError = true;
            }
            function complete() {
                helper_service_1.HelperService.log('getEntities complete');
            }
