...
var InvoicesComponent = (function () {
    function InvoicesComponent(InvoicesService, router, ledgerAccountsService, debtorsService) {
        ...
        this.loadLedgerAccounts = function () {
            ...
            function complete() {
                helper_service_1.HelperService.logError('loadLedgerAccounts complete');
            }
        };
        //////////////////////////////////////////////////////////////
        //get data
        this.loadInvoices = function () {
            ...
            function logError(e) {
                helper_service_1.HelperService.logError('getInvoices Error');
                loadInvoicesThis.getInvoicesSuccess = false;
            }
            function complete() {
                helper_service_1.HelperService.logError('getInvoices complete');
            }
        ...
        this.onRowClicked = function (params) {
            ...
            helper_service_1.HelperService.logError('Invoice onRowClicked');
        };
        ...
        helper_service_1.HelperService.logError('constructor InvoicesComponent');
