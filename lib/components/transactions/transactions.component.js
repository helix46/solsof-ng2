...
var TransactionsComponent = (function () {
    function TransactionsComponent(TransactionsService, router, routeParams, ledgerAccountsService, bankAccountsService, transactionService) {
        ...
        this.onLoadBankAccountsError = function () {
            helper_service_1.HelperService.log('onLoadBankAccountsError');
        };
        this.onLoadLedgerAccountsError = function () {
            helper_service_1.HelperService.log('onLoadLedgerAccountsError ');
        };
        ...
        this.deleteTransaction = function () {
            ...
            function deleteTransactionConfirmed() {
                ...
                function logTransactionsError(err) {
                    helper_service_1.HelperService.log('deleteTransaction Error');
                }
                function complete() {
                    helper_service_1.HelperService.log('loadTransactions complete');
                }
            }
        };
        /////////////////////////////////////////////////////////////
        ...
        helper_service_1.HelperService.log('constructor TransactionsComponent');
    ...
    TransactionsComponent.prototype.loadTransactions = function () {
        ...
        function logError(e) {
            helper_service_1.HelperService.log('getTransactions Error');
        }
        function complete() {
            helper_service_1.HelperService.log('getTransactions complete');
        }
