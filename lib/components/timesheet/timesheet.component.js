    ...
    function TimesheetComponent(timesheetService, router) {
        ...
        this.newTimesheet = function (debtors) {
            ...
            function logGetMostRecentTimesheet() {
                helper_service_1.HelperService.logError('GetMostRecentTimesheet Error');
            }
        };
        this.getTimesheet = function (timesheetID, debtors) {
            ...
            function logTimesheetError() {
                helper_service_1.HelperService.logError('getTimesheet Error');
        ...
        this.okClicked = function () {
            ...
            function complete() {
                helper_service_1.HelperService.logError('timesheet complete');
            }
        ...
        helper_service_1.HelperService.logError('constructor timesheetComponent');
    }
