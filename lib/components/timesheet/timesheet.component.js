    ...
    function TimesheetComponent(timesheetService, router) {
        ...
        this.newTimesheet = function (debtors) {
            ...
            function logGetMostRecentTimesheet() {
                helper_service_1.HelperService.log('GetMostRecentTimesheet Error');
            }
        };
        this.getTimesheet = function (timesheetID, debtors) {
            ...
            function logTimesheetError() {
                helper_service_1.HelperService.log('getTimesheet Error');
        ...
        this.okClicked = function () {
            ...
            function complete() {
                helper_service_1.HelperService.log('timesheet complete');
            }
        ...
        helper_service_1.HelperService.log('constructor timesheetComponent');
    }
