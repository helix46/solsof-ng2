    ...
    function ChangePasswordComponent(changePasswordService, router) {
        ...
        this.onSubmit = function () {
            ...
            function logError(resp) {
                ...
                helper_service_1.HelperService.log('changePassword error');
                onSubmitThis.getChangePasswordSuccess = false;
            }
            function complete() {
                var _this = this;
                helper_service_1.HelperService.log('changePassword complete');
                setTimeout(function () { return _this.router.navigate(['Entities']); }, 2000);
            }
            function onSuccess() {
                helper_service_1.HelperService.log('changePassword success');
                onSubmitThis.getChangePasswordSuccess = true;
            }
        };
        this.userId = helper_service_1.HelperService.getUsername();
        helper_service_1.HelperService.log('constructor ChangePasswordComponent');
